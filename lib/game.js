...
var makeSphericalObstacle = function (radius, x, z) {
  var geometry = new THREE.SphereGeometry(radius, 64, 64);
  var texture = THREE.ImageUtils.loadTexture('../assets/textures/spherical_obstacle.jpg');
  var material = new THREE.MeshPhongMaterial({ map: texture });
  var mesh = new THREE.Mesh(geometry, material);
...
var makeRotatingCube = function (x1, z1, x2, z2) {
  var width = Math.abs(x2 - x1);
  var height = 0.5;
  var depth = Math.abs(z2 - z1);
...
var makeHomeBall = function (radius, x, z) {
  var geometry = new THREE.SphereGeometry(radius, 64, 64);
  var texture = THREE.ImageUtils.loadTexture('../assets/textures/home.jpg');
  var material = new THREE.MeshPhongMaterial({ map: texture });
  var mesh = new THREE.Mesh(geometry, material);
